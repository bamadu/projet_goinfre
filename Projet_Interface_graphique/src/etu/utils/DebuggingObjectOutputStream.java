/*
 * Copier sur github pour mieux comprendre les erreurs lors de la (de)sérialisation
 * @source: 
 * https://github.com/busradar/busradar/blob/master/data/paths/DebuggingObjectOutputStream.java
 */
